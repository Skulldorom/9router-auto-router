...
function patchUi(targets) {
  ...
  for (const target of targets) {
    ...
    const spec = isServer ? {
      ...
      controls: '(0,w.jsxs)("div",{className:"mt-2 grid gap-2 text-xs",children:[(0,w.jsxs)("label",{className:"grid gap-1",children:["Easy target",(0,w.jsxs)("select",{className:"py-1.5 text-xs",value:o.easyTarget||"",onChange:b=>p("easyTarget",b.target.value),children:[(0,w.jsx)("option",{value:"",children:"Select combo"}),...q.filter(b=>b!==a.name).map(b=>(0,w.jsx)("option",{value:b,children:b},b))]})]}),(0,w.jsxs)("label",{className:"grid gap-1",children:["Hard target",(0,w.jsxs)("select",{className:"py-1.5 text-xs",value:o.hardTarget||"",onChange:b=>p("hardTarget",b.target.value),children:[(0,w.jsx)("option",{value:"",children:"Select combo"}),...q.filter(b=>b!==a.name).map(b=>(0,w.jsx)("option",{value:b,children:b},b))]})]}),(0,w.jsxs)("details",{className:"rounded border border-black/5 p-2 dark:border-white/10",children:[(0,w.jsx)("summary",{className:"cursor-pointer font-medium",children:"Advanced"}),(0,w.jsxs)("div",{className:"mt-2 grid gap-2",children:[(0,w.jsxs)("label",{className:"grid gap-1",children:["Hard threshold",(0,w.jsx)("input",{className:"py-1 text-xs",type:"number",min:1,value:o.hardThreshold||6,onChange:b=>{const c=Number(b.target.value);if(Number.isSafeInteger(c)&&c>0)p("hardThreshold",c)}})]}),(0,w.jsxs)("label",{className:"grid gap-1",children:["Long context threshold (characters)",(0,w.jsx)("input",{className:"py-1 text-xs",type:"number",min:1,value:o.longContextChars||24000,onChange:b=>{const c=Number(b.target.value);if(Number.isSafeInteger(c)&&c>0)p("longContextChars",c)}})]}),(0,w.jsxs)("label",{className:"grid gap-1",children:["Large tool-result threshold (characters)",(0,w.jsx)("input",{className:"py-1 text-xs",type:"number",min:1,value:o.largeToolResultChars||12000,onChange:b=>{const c=Number(b.target.value);if(Number.isSafeInteger(c)&&c>0)p("largeToolResultChars",c)}})]}),(0,w.jsxs)("label",{className:"grid gap-1",children:["Many-tools threshold",(0,w.jsx)("input",{className:"py-1 text-xs",type:"number",min:1,value:o.manyTools||16,onChange:b=>{const c=Number(b.target.value);if(Number.isSafeInteger(c)&&c>0)p("manyTools",c)}})]}),(0,w.jsxs)("label",{className:"flex items-center gap-2",children:[(0,w.jsx)("input",{type:"checkbox",checked:!!o.verbose,onChange:b=>p("verbose",b.target.checked)}),"Verbose logging"]})]})]})]})',
    } : {
      ...
      controls: '(0,l.jsxs)("div",{className:"mt-2 grid gap-2 text-xs",children:[(0,l.jsxs)("label",{className:"grid gap-1",children:["Easy target",(0,l.jsxs)("select",{className:"py-1.5 text-xs",value:v.easyTarget||"",onChange:t=>A("easyTarget",t.target.value),children:[(0,l.jsx)("option",{value:"",children:"Select combo"}),...q.filter(t=>t!==e.name).map(t=>(0,l.jsx)("option",{value:t,children:t},t))]})]}),(0,l.jsxs)("label",{className:"grid gap-1",children:["Hard target",(0,l.jsxs)("select",{className:"py-1.5 text-xs",value:v.hardTarget||"",onChange:t=>A("hardTarget",t.target.value),children:[(0,l.jsx)("option",{value:"",children:"Select combo"}),...q.filter(t=>t!==e.name).map(t=>(0,l.jsx)("option",{value:t,children:t},t))]})]}),(0,l.jsxs)("details",{className:"rounded border border-black/5 p-2 dark:border-white/10",children:[(0,l.jsx)("summary",{className:"cursor-pointer font-medium",children:"Advanced"}),(0,l.jsxs)("div",{className:"mt-2 grid gap-2",children:[(0,l.jsxs)("label",{className:"grid gap-1",children:["Hard threshold",(0,l.jsx)("input",{className:"py-1 text-xs",type:"number",min:1,value:v.hardThreshold||6,onChange:t=>{const s=Number(t.target.value);if(Number.isSafeInteger(s)&&s>0)A("hardThreshold",s)}})]}),(0,l.jsxs)("label",{className:"grid gap-1",children:["Long context threshold (characters)",(0,l.jsx)("input",{className:"py-1 text-xs",type:"number",min:1,value:v.longContextChars||24000,onChange:t=>{const s=Number(t.target.value);if(Number.isSafeInteger(s)&&s>0)A("longContextChars",s)}})]}),(0,l.jsxs)("label",{className:"grid gap-1",children:["Large tool-result threshold (characters)",(0,l.jsx)("input",{className:"py-1 text-xs",type:"number",min:1,value:v.largeToolResultChars||12000,onChange:t=>{const s=Number(t.target.value);if(Number.isSafeInteger(s)&&s>0)A("largeToolResultChars",s)}})]}),(0,l.jsxs)("label",{className:"grid gap-1",children:["Many-tools threshold",(0,l.jsx)("input",{className:"py-1 text-xs",type:"number",min:1,value:v.manyTools||16,onChange:t=>{const s=Number(t.target.value);if(Number.isSafeInteger(s)&&s>0)A("manyTools",s)}})]}),(0,l.jsxs)("label",{className:"flex items-center gap-2",children:[(0,l.jsx)("input",{type:"checkbox",checked:!!v.verbose,onChange:t=>A("verbose",t.target.checked)}),"Verbose logging"]})]})]})]})',
    };
