...
const uiMarker = "9router-auto-router-ui:v7";
...
function applyUiPlan(source, plan, target) {
  ...
  const legacySetup = `const _arSavedConfig=_arInitialStrategy.autoRouter&&typeof _arInitialStrategy.autoRouter==="object"?_arInitialStrategy.autoRouter:{},_arLegacyTargets=typeof _arSavedConfig.easyTarget==="string"&&_arSavedConfig.easyTarget.trim()&&typeof _arSavedConfig.hardTarget==="string"&&_arSavedConfig.hardTarget.trim(),_arStoredModels=${modelInitial},_arHasExplicitOrder=Array.isArray(_arStoredModels)&&_arStoredModels.length>0,_arEffectiveModels=_arLegacyTargets&&!_arHasExplicitOrder?[_arSavedConfig.easyTarget.trim(),_arSavedConfig.hardTarget.trim()]:null;`;
